...
function CTA({ label = "無料個別相談に申し込む" }: { label?: string }) {
  return <div className="ctaWrap"><div className="urgencyBar"><span><small>募集人数</small><b>限定15名</b></span><span><small>受付期間</small><b>募集開始から3日間</b></span></div><a className="cta" href="#form-pending">{label}<small>1時間程度・日程は個別に調整します</small></a><span className="formNote">※申込フォームは準備中です</span></div>;
}
...
export default function Home() {
  return <main>
    <section className="hero">
      ...
      <div className="heroImage hopeImage"><Image src="/images/hero-reunion-v2.png" alt="再び寄り添い笑い合うカップル" fill priority sizes="(max-width:720px) 100vw,720px"/><div className="imageShade"/><p className="imageMessage">彼を想って苦しくなる毎日から、<br /><strong>また彼の隣で笑っている毎日へ。</strong></p></div>
    ...
    <section className="editorialImage"><div className="editorialPhoto"><Image src="/images/searching-answers.png" alt="復縁について調べても自分の答えが見つからず考え込む女性" fill sizes="(max-width:720px) 100vw,720px"/><div className="editorialShade"/><div className="editorialCaption"><span>調べても、学んでも</span><h2>「私と彼の場合」が<br />分からない。</h2><p>必要なのは、知識をもう一つ増やすことではなく、あなた自身に残った痛みを見ることでした。</p></div></div></section>

    <section className="section purification"><div className="lightOrb"/><p className="chapter">あなたが悪いわけではありません</p><h2>必要なのは、さらに<br />復縁の知識を増やすことではありません</h2><p>彼を失ったときに残った痛みや不安を手放して、<br />本来のあなたに戻していくこと。</p><div className="purificationVisual"><Image src="/images/healing-light.png" alt="朝の光の中で穏やかな表情を取り戻す女性" fill sizes="(max-width:720px) 100vw,720px"/><div className="purificationShade"/><div className="purificationCopy"><p>それが、僕の言う</p><h3>「浄化」なんです。</h3><h2>傷ついたあなたではなく、<br /><em>本来のあなた</em>として<br />彼と向き合うために。</h2></div></div></section>

    <section className="section soul"><div className="sectionHeading"><h2>魂の濁りは、彼との別れだけで<br />できたものじゃない</h2></div><ul className="woundList"><li>昔の彼に浮気された</li><li>好きだった人に突然フラれた</li><li>小さい頃から誰かと比べられてきた</li><li>大切だった人に離れられた</li></ul><p>そんな小さな傷が、魂に少しずつ残っていく。<br /><br />返信が遅いだけで不安になったり、他の女性が気になったり、我慢した気持ちを最後にぶつけてしまったり。</p></section>

    <section className="mirrorStory"><div className="mirrorPhoto"><Image src="/images/inner-wounds.png" alt="鏡の中の自分と静かに向き合う女性" fill sizes="(max-width:720px) 100vw,720px"/><div className="mirrorShade"/><div className="mirrorCopy"><p>同じことを繰り返してしまうのは、</p><h2>あなたが変われていない<br />からではありません。</h2><strong>昔できた傷が、癒えていないまま<br />魂の中に残っているからなんです。</strong></div></div></section>
    ...
    <section className="section finale"><p>彼ともう一度やり直したいなら、<br />そのために今できることを一緒に見つければいい。</p><p>まだ自分の気持ちが分からないなら、<br />無理に答えを決めなくても大丈夫です。</p><div className="finalQuote"><span>いつか、また彼の隣で笑いながら</span><h2>「あの時、諦めなくてよかった」</h2><p>そう思える未来を、<br />一緒に目指していきましょう。</p></div><div className="finalHappyPhoto"><Image src="/images/final-happy-couple.png" alt="夕暮れの中で幸せそうに笑い合うカップル" fill sizes="(max-width:720px) 100vw,720px"/><div className="finalHappyShade"/><p>また彼の隣で、<br /><strong>心から笑える未来へ。</strong></p></div><CTA label="ジローに個別相談してみる"/><p className="signature">復縁アドバイザー　ジロー</p></section>
