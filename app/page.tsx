...
export default function Home() {
  return <main>
    ...
    <section className="section purification"><p className="chapter">あなたが悪いわけではありません</p><h2 className="knowledgeHeading">必要なのは、さらに復縁の知識を<br />増やすことではありません</h2><p>別れにつながった考え方や行動を整理して、<br />彼と落ち着いて向き合える自分に変わっていくこと。</p><div className="purificationVisual"><Image src="/images/inner-wounds.png" alt="鏡の前で自分の心と向き合う女性" fill sizes="(max-width:720px) 100vw,720px"/><div className="purificationShade"/><div className="purificationCopy"><p>彼に好かれるために<br />自分を偽るのではなく</p><h3>「オーラ覚醒」</h3><h2><em>不安に振り回されない自分</em>として<br />彼と向き合えるようになること。</h2></div></div></section>
