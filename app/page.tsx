...
export default function Home() {
  return <main>
    ...
    <section className="section soul"><div className="sectionHeading"><h2>魂の濁りは、彼との別れだけで<br />できたものじゃない</h2></div><div className="soulDiagram"><Image src="/images/soul-clouding-illustration.png" alt="外から受けた傷が魂に残っていくイメージ" fill sizes="(max-width:720px) 100vw,720px"/><strong>魂</strong><span className="impact impact1">浮気された傷</span><span className="impact impact2">突然の別れ</span><span className="impact impact3">比べられた記憶</span><span className="impact impact4">大切な人の離別</span></div><ul className="woundList"><li>昔の彼に浮気された</li><li>好きだった人に突然フラれた</li><li>小さい頃から誰かと比べられてきた</li><li>大切だった人に離れられた</li></ul><p>そんな小さな傷が、魂に少しずつ残っていく。<br /><br />返信が遅いだけで不安になったり、他の女性が気になったり、我慢した気持ちを最後にぶつけてしまったり。</p><div className="repetitionCallout"><p>同じことを繰り返してしまうのは、</p><h2>あなたが変われていない<br />からではありません。</h2><strong>昔できた傷が、癒えていないまま<br />魂の中に残っているからなんです。</strong></div></section>
